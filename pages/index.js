...
export default function Home(/* {id, nft, metadata } */) {
  ...
  return (
    <div className='px-8 py-0 border-solid border-2 border-red-500'>
      <Head>
      ...
      <main className="border-solid border-red-500 border-2 text-white min-h-screen px-0 py-8 flex flex-1 flex-col  items-center">                        
        <Header />
{/*         <h2>
        ...
        {loading ? <LoadingHeaderData /> : <DisplayDataHeader count={askCount} />}
